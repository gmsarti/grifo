...
{"nome": "<nome-folha>"}
Nunca substitua um nome folha pelo nome da família ou subfamília a que ele pertence.
...
Nunca use o nome de uma super-familia, em vez da familia usada pelo usuário.
...
Nome: adjacente
Aparece quando: o texto diz que um objeto esta adjacente a ou encostado em um outro objeto.
Saída:  {"tipo": "restricao", "padrao": "adjacente", "objeto1": <objeto>, "objeto2": <objeto>}
...
Aparece quando: o texto diz que o core de um objeto ou de multiplos objetos não devem ter sobreposição.
Saída: {"tipo": "restricao", "padrao": "nao_sobreposicao_core", "objeto": <objeto>}

Nome: nao_sobreposicao_acesso
Aparece quando: o texto diz que o acesso de um objeto ou de multiplos objetos não devem ter sobreposição.
...
Nome: preferencia_separacao_maxima
Aparece quando: o texto diz preferencialmente que um objeto deve estar o mais longe possível de outro objeto.
Saída: {"tipo": "preferencia", "padrao": "preferencia_separacao_maxima", "objeto1": <objeto>, "objeto2": <objeto>}
...
Para todos os exemplos abaixo assuma:

Objetos: 
{
 'porta': [],
 'forro': ['luminaria-parede-1', 'luminaria-teto-1', 'candelabro'],
 'movel': {'cofre': [],
  'cama': ['cama_solteiro', 'cama_casal', 'cama_queen'],
  'mesa': ['mesa2x2', 'mesa_circular', 'mesa 2x3'],
  'sofa': ['sofa 3 lugares']
 }

 Lados alternativos:
 [{'nome': 'cama', 'fundos': 'cabeceira', 'frente': 'pe'},
]

Zonas:
    ["zona 1"]

Exemplos de diferentes textos e suas respostas corretas

1)

  Texto: "os moveis devem estar na zona 1, e o candelabro deve estar sobre a mesa"

  Resposta: [{'tipo': 'restricao',
  'padrao': 'dentro_zona',
  'objeto': {'nome': 'movel'},
  'zona': 'zona central'},
 {'tipo': 'restricao',
...
2) 
  ...
  texto: "o pe da cama de solteiro deve estar encostada na parede"

  resposta: [{'tipo': 'restricao',
  'padrao': 'encostado',
  'objeto': {'nome': 'cama_solteiro'},
  'lado': 'frente'}]

3) 
  
  texto: "o pe da mesa deve estar encostada na parede"
  ...
  explicacao: o termo "pe" pode ser usado como a frente da cama, mas apenas para a cama. Pe NAO é um nome de lado correto para a mesa

4) 

  texto: "A cama deve estar virada para a pentiadeira"
  ...
  explicacao: não há um objeto "janela" definido na hierarquia de objetos.
